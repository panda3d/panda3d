...
/**
 * Configure the local DSP filter chain.  There is no guarantee that any given
 * configuration will be supported by the implementation.  The only way to find
 * out what's supported is to call configure_filters.  If it returns true, the
