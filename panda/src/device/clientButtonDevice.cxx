...
/**
 * Sets the state of the indicated button index, where true indicates down, and
 * false indicates up.  This may generate a ButtonEvent if the button has an
 * associated ButtonHandle.  The caller should ensure that acquire() is in
