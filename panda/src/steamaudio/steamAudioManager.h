...
private:
  ...
  void starting_sound(SteamAudioSound* audio);
  void stopping_sound(SteamAudioSound* audio);
...
private:
  ...
  typedef phash_set<SteamAudioSound*> AllSounds;
  ...
  typedef pset<SteamAudioManager*> Managers;
