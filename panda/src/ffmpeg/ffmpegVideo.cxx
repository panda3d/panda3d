...
/**
 * Constructs an ffmpeg video that reads its contents from the indicated subfile
 * information.  This is normally used for low-level purposes only; you would
 ...
 * FfmpegVideo is encountered in the Bam file.  It should create the FfmpegVideo
