...
get_vertex(int n) const {
  nassertr(_created_data != (GeomVertexData *)nullptr, LVertex::zero());
...
set_vertex(int n, const LVertex &vert) {
  nassertv(_created_data != (GeomVertexData *)nullptr);
...
get_vertex_color(int n) const {
  nassertr(_created_data != (GeomVertexData *)nullptr, LColor::zero());
