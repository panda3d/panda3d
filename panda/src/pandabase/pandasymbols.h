...
#ifdef BUILDING_PANDA_STEAMAUDIO
#define EXPCL_PANDA_STEAMAUDIO EXPORT_CLASS
#define EXPTP_PANDA_STEAMAUDIO EXPORT_TEMPL
#else
#define EXPCL_PANDA_STEAMAUDIO IMPORT_CLASS
#define EXPTP_PANDA_STEAMAUDIO IMPORT_TEMPL
#endif
