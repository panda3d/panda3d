...
#ifdef BUILDING_STEAM_AUDIO
#define EXPCL_STEAM_AUDIO EXPORT_CLASS
#define EXPTP_STEAM_AUDIO EXPORT_TEMPL
#else
#define EXPCL_STEAM_AUDIO IMPORT_CLASS
#define EXPTP_STEAM_AUDIO IMPORT_TEMPL
#endif
