...
/**
 * Returns a matrix that transforms from the indicated coordinate system to the
...
/**
 * Sorts matrices lexicographically, componentwise.  Returns a number less than
 * 0 if this matrix sorts before the other one, greater than zero if it sorts
 ...
 * Datagram::set_stdfloat_double().  This is appropriate when you want to write
 * a fixed-width value to the datagram, especially when you are not writing a
 * bam file.
 */
void FLOATNAME(LMatrix3)::
...
/**
 * Writes the matrix to the Datagram using add_stdfloat().  This is appropriate
 * when you want to write the matrix using the standard width setting,
