 ...
 * University of Canterbury, New Zealand, and ARToolworks, Inc, Seattle.  It is
 * available under a GPL license.  It is also possible to negotiate other
 * licenses with the copyright holders.  This class is a wrapper around the
 * ARToolKit library.
 */
