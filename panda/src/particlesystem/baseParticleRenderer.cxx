...
/**
 * Sets the "ignore scale" flag.  When this is true, particles will be drawn as
 * if they had no scale, regardless of whatever scale might be inherited from
 * above the render node in the scene graph.  This flag is mainly useful to
 * support legacy code that was written for a very early version of Panda, whose
 * sprite particle renderer had a bug that incorrectly ignored the inherited
 * scale.
 */
