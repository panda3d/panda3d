...
/**
 * Returns the interpolated color according to the segment's function and start
 * and end times.  't' is a value in [0-1] where corresponds to beginning of the
 * segment and 1 corresponds to the end.
 */
...
/**
 * Adds a constant segment of the specified color to the manager and returns the
