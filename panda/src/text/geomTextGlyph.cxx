 ...
 * GeomTextGlyph, they both must be.)  Returns true if the copy is successful,
 * or false otherwise (because the Geoms were mismatched).
 */
bool GeomTextGlyph::
 ...
 * reference counting mechanism.  Does nothing if the other Geom is not a
 * GeomTextGlyph.
 */
void GeomTextGlyph::
