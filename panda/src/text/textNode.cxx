...
/**
 * Returns the width of a single character of the font, or 0.0 if the character
 * is not known.  This may be a wide character (greater than 255).
 */
...
/**
 * Returns the width of a line of text of arbitrary characters.  The line should
 * not include the newline character or any embedded control characters like \1
 * or \3.
 */
PN_stdfloat TextNode::
 ...
 * TextNode is parented within the scene graph.  In general, you should not call
 * this method.  Call generate() instead if you want to get a handle to geometry
 * that represents the text.  This method is provided as a debugging aid only.
 */
PandaNode *TextNode::
