...
/**
 * Adds a new collider to the list with a NodePath that will be updated with the
 * collider's new position, or updates the existing collider with a new NodePath
 * object.
 */
void CollisionHandlerPhysical::
 ...
 * Adds a new collider to the list with a NodePath that will be updated with the
 * collider's new position, or updates the existing collider with a new NodePath
 * object.  The indicated DriveInterface will also be updated with the target's
 * new transform each frame.  This method should be used when the target is
