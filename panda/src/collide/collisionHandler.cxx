 ...
 * required for the handler.  The return value is normally true, but if this
 * returns value, the CollisionTraverser will remove the handler from its list,
 * allowing the CollisionHandler itself to determine when it is no longer
 * needed.
 */
