...
/**
 * Returns the point, on the surface of the "into" object, at which a collision
 * is detected.  This can be thought of as the first point of intersection.
 * However the contact point is the actual first point of intersection.  The
 * point will be converted into whichever coordinate space the caller specifies.
 */
 ...
 * collision is detected.  The normal will be converted into whichever
 * coordinate space the caller specifies.
 */
...
/**
 * Returns the point, within the interior of the "into" object, which represents
 * the depth to which the "from" object has penetrated.  This can also be
 * described as the intersection point on the surface of the "from" object
 * (which is inside the "into" object).  It can be thought of as the deepest
 * point of intersection.  The point will be converted into whichever coordinate
 ...
 * point of the collision into the indicated coordinate space.  Returns true if
 * all three properties are available, or false if any one of them is not.
 */
bool CollisionEntry::
...
/**
 * Returns the position of the "from" object at the instant that a collision is
 * first detected.  The position will be converted into whichever coordinate
 * space the caller specifies.
 */
LPoint3 CollisionEntry::
...
/**
 * Returns the surface normal of the "into" object at the contact position.  The
 * normal will be converted into whichever coordinate space the caller
 * specifies.
 */
LVector3 CollisionEntry::
 ...
 * collision into the indicated coordinate space.  Returns true if all three
 * properties are available, or false if any one of them is not.
 */
bool CollisionEntry::
