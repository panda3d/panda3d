...
/**
 * Creates a ComputeNode with the given name.  Use add_dispatch and  also assign
 * a shader using a ShaderAttrib.
 */
ComputeNode::
 ...
 * ComputeNode is encountered in the Bam file.  It should create the ComputeNode
