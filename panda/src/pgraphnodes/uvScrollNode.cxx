 ...
 * The return value is \true if this node should be visible, or false if it
 * should be culled.
 */
bool UvScrollNode::
...
/**
 * Returns true if it is generally safe to combine this with other nodes, which
 * it isn't, so don't.  Ever.
 */
bool UvScrollNode::
