...
/**
 * Returns a newly-generated Texture that renders a circular spot image as might
 * be cast from the spotlight.  This may be projected onto target geometry (for
 * instance, via NodePath::project_texture()) instead of actually enabling the
 * light itself, as a cheesy way to make a high-resolution spot appear on the
 * geometry.  pixel_width specifies the height and width of the new texture in
 * pixels, full_radius is a value in the range 0..1 that indicates the relative
 * size of the fully bright center spot, and fg and bg are the colors of the
 ...
 * Spotlight is encountered in the Bam file.  It should create the Spotlight and
