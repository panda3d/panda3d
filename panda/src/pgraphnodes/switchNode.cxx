 ...
 * relevant data from the BamFile for the new SwitchNode.
 */
void SwitchNode::CData::
 ...
 * type SwitchNode is encountered in the Bam file.  It should create the
 * SwitchNode and extract its information from the file.
 */
