...
#if defined(_WIN32) and defined(LIBRESSL_VERSION_NUMBER)
/**
* This exists to work around an issue with LibreSSL's version
* of BIO_sock_should_retry, which does not understand Windows error codes.
...
#else
#define should_retry(err) BIO_sock_should_retry(err)
#endif
