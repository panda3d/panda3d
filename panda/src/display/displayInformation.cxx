...
/**
 * Returns the number of individual CPU cores in the system, or 0 if this number
 * is not available.  A hyperthreaded CPU counts once here.
 */
int DisplayInformation::
get_num_cpu_cores() {
...
/**
 * Returns the number of logical CPU's in the system, or 0 if this number is not
 * available.  A hyperthreaded CPU counts as two or more here.
 */
int DisplayInformation::
