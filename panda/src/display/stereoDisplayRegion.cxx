...
/**
 * Sets the active flag on both the left and right DisplayRegions to the
 * indicated value.
 */
void StereoDisplayRegion::
...
/**
 * Sets the indicated sort value on the overall DisplayRegion, the indicated
 * sort value + 1 on the left eye, and the indicated sort value + 2 on the right
 * eye.
 */
void StereoDisplayRegion::
set_sort(int sort) {
...
/**
 * Sets the stereo channels on the left and right eyes, and also sets the active
 * flags independently on both eyes.  For a StereoDisplayRegion, a different
 * action is performed for each different value:  SC_stereo - the left eye is
 * set to SC_left, the right eye to SC_right, and both eyes are activated.
 * SC_left - the left eye is set to SC_left and activated; the right eye is
 * deactivated.  SC_right - the right eye is set to SC_right and activated; the
 * left eye is deactivated.  SC_mono - the left eye is set to SC_mono and
 * activated; the right eye is deactivated.  This call also resets
 * tex_view_offset to its default value, which is 0 for the left eye or 1 for
 * the right eye of a stereo display region, or 0 for a mono display region.
 */
void StereoDisplayRegion::
 ...
 * any multiview textures that are rendered within this DisplayRegion.  When you
 * call this on a StereoDisplayRegion, it automatically sets the specified value
 * on the left eye, and the specified value + 1 on the right eye.
 */
void StereoDisplayRegion::
...
/**
 * Sets the incomplete_render flag on both the left and right DisplayRegions to
 * the indicated value.
 */
void StereoDisplayRegion::
...
/**
 * Sets the texture_reload_priority on both the left and right DisplayRegions to
 * the indicated value.
 */
void StereoDisplayRegion::
...
/**
 * Sets the page and view on both the left and right DisplayRegions to the
 * indicated value.
 */
void StereoDisplayRegion::
