...
make_screenshot_filename(std::string_view prefix) {
 ...
 */
Filename DisplayRegion::
save_screenshot_default(std::string_view prefix) {
 ...
 */
bool DisplayRegion::
save_screenshot(const Filename &filename, std::string image_comment) {
  PNMImage image;
