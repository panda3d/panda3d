 ...
 * convenience of Python, which likes to deal with ints; C++ code should use one
 * of the more specific make_x11() or make_win32() methods instead.
 */
 ...
 * communication.  This is (at present, and maybe always) useful only on the OS
 * X platform, where parenting child windows is particularly problematic.
 */
PT(WindowHandle) NativeWindowHandle::
