 ...
 * value.  This doesn't change the shape or timing of the curve; however, it is
 * irreversible: if the new CV is immediately removed, the curve will be
...
/**
 * Sets the value of the indicated knot.  There are get_num_cvs() + _order knot
 * values, but the first _order - 1 and the last 1 knot values cannot be
...
/**
 * Adds a new CV to the end of the curve.  Creates a new knot value by adding 1
 * to the last knot value.  Returns the index of the new CV.
 */
int NurbsCurve::
...
/**
 * Finds the first knot whose value is >= t, or -1 if t is beyond the end of the
 * curve.
 */
int NurbsCurve::
