 ...
 * initialized.  This should be called by every implementation of make_reader()
 * and make_writer(), to ensure that the library is properly initialized before
 ...
 * object, in preparation for writing to a Bam file.  None of the particular
 * PNMFileType objects store any extra data--at least, not yet--so we just
 * define this up here to do nothing.
 */
void PNMFileType::
