...
PUBLISHED:
  ...
  PNMFileType *get_type_from_extension(std::string_view filename) const;
  PNMFileType *get_type_from_magic_number(std::string_view magic_number) const;
...
private:
  ...
  typedef pmap<std::string, Types, std::less<>> Extensions;
