...
/**
 * Creates a new DatagramSinkNet with the indicated number of threads to handle
 * writing.  Normally num_threads should be either 0 or 1 to guarantee that
 * datagrams are delivered in the same order in which they were sent.
 */
DatagramSinkNet::
...
/**
 * Returns true if there is an error on the target connection, or if the target
 * has never been set.
 */
bool DatagramSinkNet::
is_error() {
