...
/**
 * Sets the address up to refer to a particular port, but not to any particular
 * IP.  Returns true if successful, false otherwise (currently, this only
 * returns true).
 */
bool NetAddress::
set_any(int port) {
...
/**
 * Returns the IP address to which this address refers, as a 32-bit integer, in
 * host byte order.
 */
 ...
 * components; component 0 is the first (leftmost), and component 3 is the last
