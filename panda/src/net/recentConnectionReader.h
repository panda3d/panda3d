 ...
 * particularly for reading telemetry-type data from UDP sockets where you don't
 * care about getting every last socket, and in fact if the sockets are coming
 * too fast you'd prefer to skip some of them.  This class will always create
 * one thread for itself.
 */
