...
/*
 * The functions defined here are used for testing purposes only by some of the
 * various test_* programs in this directory.  They are not compiled into the
 * package library, libnet.so.  These functions are handy for getting and
