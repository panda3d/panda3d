...
/**
 * This function must be declared because it is pure virtual in the base class,
 * but it isn't used in this class and doesn't do anything.
 */
...
/**
 * This is the function that is called when activity is detected on a rendezvous
 * port.  In this case, it performs the accept().
 */
