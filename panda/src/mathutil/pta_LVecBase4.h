 ...
 * defining the pta again.  We actually wrap UnalignedLVecBase4f, in case we are
 * building with SSE2 and LVecBase4f requires strict alignment.
 */
 ...
 * PANDA.DLL; other packages that want to use a pta of this type (whether they
 * need to export it or not) should include this header file, rather than
 * defining the pta again.  We actually wrap UnalignedLVecBase4d, in case we are
 * building with SSE2 and LVecBase4d requires strict alignment.
 */
 ...
 * PANDA.DLL; other packages that want to use a pta of this type (whether they
 * need to export it or not) should include this header file, rather than
 * defining the pta again.  We actually wrap UnalignedLVecBase4i, in case we are
 * building with SSE2 and LVecBase4i requires strict alignment.
 */
