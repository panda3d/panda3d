 ...
 * successful, false if the volume doesn't know how to do that or can't do that.
 */
bool BoundingVolume::
 ...
 * element in the list is known to be a nonempty sphere.
 */
bool BoundingVolume::
...
/**
 * Double-dispatch support: called by around_other() when the type of the first
 * element in the list is known to be a nonempty box.
 */
bool BoundingVolume::
...
/**
 * Double-dispatch support: called by around_other() when the type of the first
 * element in the list is known to be a nonempty hexahedron.
 */
bool BoundingVolume::
...
/**
 * Double-dispatch support: called by around_other() when the type of the first
 * element in the list is known to be a union object.
 */
bool BoundingVolume::
...
/**
 * Double-dispatch support: called by around_other() when the type of the first
 * element in the list is known to be an intersection object.
 */
bool BoundingVolume::
