...
/**
 * Defines a scaling factor for roll forces that affect the chassis.  0.0 means
 * no roll - the chassis won't ever flip over - while 1.0 means original
 * physical behaviour.  Basically, this allows moving the center of mass up and
 * down.
 */
void BulletWheel::
