 ...
 * There are no virtual functions here, for performance reasons; it is generally
 * desirable to generate hash numbers as quickly as possible.  The derived
 * classes must redefine all the basic functionality.  Thus, a compile-time
 * decision must be made for the kind of HashGenerator that is appropriate for a
 * particular class.
 */
