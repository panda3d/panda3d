 ...
 * the other one.  This should return 0 if the two CharacterJointEffect objects
 ...
 * called with two CharacterJointEffect objects whose get_type() functions
 * return the same.
 */
 ...
 * CharacterJointEffect is encountered in the Bam file.  It should create the
 * CharacterJointEffect and extract its information from the file.
 */
