 ...
 * number of vertices, like lines, returns the number of vertices per primitive.
 * If the primitive type is a more complex type in which different primitives
 * might have different numbers of vertices, for instance a line strip, returns
 * 0.
 */
int GeomLines::
