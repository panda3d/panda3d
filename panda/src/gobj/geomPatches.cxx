 ...
 * constructor, and it may not be changed during the lifetime of the GeomPatches
 * object.  Create a new GeomPatches if you need to have a different value.
 */
GeomPatches::
 ...
 * number of vertices, like patches, returns the number of vertices per
 ...
 * strip, returns 0.  In the case of GeomPatches, this returns the fixed number
