 ...
 * rows as it goes.  Although it doesn't provide any real performance benefit
 * over using a separate reader and writer on the same data, it should probably
 * be used in preference to a separate reader and writer, because it makes an
 * effort to manage the reference counts properly between the reader and the
 * writer to avoid accidentally dereferencing either array while recopying.
 */
