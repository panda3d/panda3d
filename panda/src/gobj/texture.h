...
PUBLISHED:
  ...
  // Could use MAKE_PROPERTY2 with 5 parameters for ram_image, if set_ram_image
  // wouldn't require parameters
  MAKE_PROPERTY2(ram_image, has_ram_image, get_ram_image);
  MAKE_PROPERTY(uncompressed_ram_image, get_uncompressed_ram_image);
