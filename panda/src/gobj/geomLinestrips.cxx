 ...
 * definition.  If the decomposition cannot be performed, this might return the
 * original object.  This method is useful for application code that wants to
 * iterate through the set of lines on the primitive without having to write
 * handlers for each possible kind of primitive type.
 */
