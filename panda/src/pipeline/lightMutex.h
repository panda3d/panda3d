 ...
 * LightMutex class compiles to nothing; it performs no locking whatsoever.  It
 * is therefore useful only to protect very small sections of code, during which
 * you are confident there will be no thread yields.  In the normal, system-
 * threaded implementation, this class is exactly the same as Mutex.
