...
get_elapsed_time() const {
  ...
  nassertr(_manager != (AsyncTaskManager *)nullptr, 0.0);
...
get_elapsed_frames() const {
  ...
  nassertr(_manager != (AsyncTaskManager *)nullptr, 0);
  ...
  if (chain_name != _chain_name) {
    if (_manager != (AsyncTaskManager *)nullptr) {
      ...
      if (_state == S_active) {
        ...
        nassertv(chain_a != (AsyncTaskChain *)nullptr);
  ...
  if (sort != _sort) {
    if (_manager != (AsyncTaskManager *)nullptr) {
      ...
      if (_state == S_active && _sort >= _chain->_current_sort) {
        ...
        nassertv(chain != (AsyncTaskChain *)nullptr);
...
jump_to_task_chain(AsyncTaskManager *manager) {
  ...
  if (chain_b == (AsyncTaskChain *)nullptr) {
    task_cat.warning()
...
upon_death(AsyncTaskManager *manager, bool clean_exit) {
  ...
  if (manager != (AsyncTaskManager *)nullptr) {
