...
PGTop::
~PGTop() {
  set_mouse_watcher((MouseWatcher *)nullptr);
}
...
cull_callback(CullTraverser *trav, CullTraverserData &data) {
  ...
  if (_watcher_group != (PGMouseWatcherGroup *)nullptr) {
  ...
  if (_watcher_group != (PGMouseWatcherGroup *)nullptr) {
    nassertr(_watcher != (MouseWatcher *)nullptr, false);
...
set_mouse_watcher(MouseWatcher *watcher) {
  ...
  if (_watcher != (MouseWatcher *)nullptr) {
    _watcher->remove_group(_watcher_group);
  }

  _watcher = watcher;
  _watcher_group = (PGMouseWatcherGroup *)nullptr;
