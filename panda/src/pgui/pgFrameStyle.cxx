...
/**
 * Computes the size of the internal frame, given the indicated external frame,
 * appropriate for this kind of frame style.  This simply subtracts the border
...
/**
 * Applies the indicated transform to the FrameStyle.  The return value is true
 * if the frame style is transformed, or false if it was not affected by the
 * transform.
 */
bool PGFrameStyle::
...
/**
 * Generates geometry representing a frame of the indicated size, and parents it
 * to the indicated node, with the indicated scene graph sort order.  The return
 * value is the generated NodePath, if any, or an empty NodePath if nothing is
 * generated.
 */
