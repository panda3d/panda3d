...
/**
 * Called whenever the "focus_out" event is triggered on a watched PGItem.  See
 * PGItem::focus_out().
 */
void PGItemNotify::
...
/**
 * Called whenever the "keystroke" event is triggered on a watched PGItem.  See
 * PGItem::keystroke().
 */
void PGItemNotify::
...
/**
 * Called whenever the "candidate" event is triggered on a watched PGItem.  See
 * PGItem::candidate().
 */
void PGItemNotify::
