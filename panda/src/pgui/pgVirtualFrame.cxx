...
/**
 * Sets the bounding rectangle of the clip frame.  This is the size of the small
 * window through which we can see the virtual canvas.  Normally, this is the
 * same size as the actual frame or smaller (typically it is smaller by the size
 * of the bevel, or to make room for scroll bars).
 */
void PGVirtualFrame::
