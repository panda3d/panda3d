...
EggMesherFanMaker(int vertex, EggMesherStrip *tri,
  ...
  if (edge != (const EggMesherEdge *)nullptr) {
...
join(EggMesherFanMaker &other) {
  ...
  nassertr(my_back != (EggMesherEdge *)nullptr &&
           other_front != (EggMesherEdge *)nullptr, false);
  ...
  nassertr(my_front != (EggMesherEdge *)nullptr &&
           other_back != (EggMesherEdge *)nullptr, false);
