...
/**
 * Removes the first instance of the indicated object type from the group if it
 * is present.  Returns true if the object type was found and removed, false
 * otherwise.
 */
bool EggGroup::
...
/**
 * Writes the flags inherited from EggRenderMode and similar flags that control
 * obscure render effects.
 */
void EggGroup::
 ...
 * such object at this level or above this group that has an alpha_mode other
...
/**
 * Walks back up the hierarchy, looking for an EggGroup or EggPrimitive or some
 * such object at this level or above this group that has a depth_write_mode
...
/**
 * Walks back up the hierarchy, looking for an EggGroup or EggPrimitive or some
 * such object at this level or above this group that has a depth_test_mode
 * other than DTM_unspecified.  Returns a valid EggRenderMode pointer if one is
 * found, or NULL otherwise.
 */
EggRenderMode *EggGroup::
...
/**
 * Walks back up the hierarchy, looking for an EggGroup or EggPrimitive or some
 * such object at this level or above this group that has a visibility_mode
 * other than VM_unspecified.  Returns a valid EggRenderMode pointer if one is
 * found, or NULL otherwise.
 */
EggRenderMode *EggGroup::
...
/**
 * Walks back up the hierarchy, looking for an EggGroup or EggPrimitive or some
 * such object at this level or above this group that has a depth_offset
...
/**
 * Walks back up the hierarchy, looking for an EggGroup or EggPrimitive or some
 * such object at this level or above this group that has a draw_order
 * specified.  Returns a valid EggRenderMode pointer if one is found, or NULL
 * otherwise.
 */
EggRenderMode *EggGroup::
...
/**
 * Walks back up the hierarchy, looking for an EggGroup or EggPrimitive or some
 * such object at this level or above this group that has a bin specified.
...
/**
 * Adds the vertex to the set of those referenced by the group, at the indicated
 * membership level.  If the vertex is already being referenced, increases the
...
/**
 * Adds a new <Ref> entry to the group.  This declares an internal reference to
 * another node, and is used to implement scene-graph instancing; it is only
 * valid if the group_type is GT_instance.
 */
void EggGroup::
...
/**
 * Returns the GroupType value associated with the given string representation,
 * or GT_invalid if the string does not match any known GroupType value.
 */
...
/**
 * Returns the DCSType value associated with the given string representation, or
 * DC_unspecified if the string does not match any known DCSType value.
 */
...
/**
 * Returns the BlendMode value associated with the given string representation,
 * or BM_none if the string does not match any known BlendMode.
 */
...
/**
 * Writes out the vertex ref component of the group body only.  This may consist
 * of a number of <VertexRef> entries, each with its own membership value.
 */
void EggGroup::
...
/**
 * This virtual method is inherited by EggTransform3d; it is called whenever the
