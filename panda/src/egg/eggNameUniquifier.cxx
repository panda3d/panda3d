...
/**
 * Returns the node associated with the given category and name, or NULL if the
...
/**
 * Adds the name to the indicated category.  This name will not be used for any
 * other egg node within this category.  Returns true if the name was added, or
