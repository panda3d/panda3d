...
/**
 * The main entry point to EggBinMaker.  Walks the egg scene graph beginning at
 * the indicated root node, and moves all binnable nodes into EggBin objects.
 ...
 * required.  child is an arbitrary child of the bin, and collapse_from is the
 * group the bin is being collapsed with, if any (implying collapse_group()
 * returned true), or NULL if not.
 */
