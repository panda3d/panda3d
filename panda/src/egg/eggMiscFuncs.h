...
/*
 * eggMiscFuncs.h This contains the prototypes for functions that are useful to
 * internal egg code.  Also see eggUtilities.h, which contains functions that
 * may be useful to the rest of the world.
 */
