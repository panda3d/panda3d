...
/**
 * Indicates whether the intersection of this and b is empty or not in the plane
 * orthogonal to the axis passed (X = 0, Y = 1 or Z = 2).
 */
bool PhysxBounds3::
 ...
 * assigns the results' bounds to this.  The orientation is applied first, then
 * the translation.
 */
void PhysxBounds3::
