...
/**
 * Set the number of solver iterations performed when processing joint/contacts
...
/**
 * Get the number of solver iterations performed when processing joint/contacts
 * connected to this body.
 */
