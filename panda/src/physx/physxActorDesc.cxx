...
/**
 * Set the density used during mass/intertia computation.  This value is used if
 * the actor's shapes do not have a mass asigned.
 */
void PhysxActorDesc::
...
/**
 * Sets the body descriptor for this actor.  The actor will be dynmaic if a body
 * descriptor is set, and static if no body descriptor is set.
 */
void PhysxActorDesc::
