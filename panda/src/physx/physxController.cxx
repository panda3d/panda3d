 ...
 * supported.  Pitch and roll are constrained by PhysX in order to alyways keep
...
/**
 * The character controller uses caching in order to speed up collision testing,
