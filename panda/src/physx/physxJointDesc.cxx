...
/**
 * Set the Z axis of joint space, in actor[i]'s space.  This is the primary axis
 * of the joint.  idx must be either 0 or 1.
 */
void PhysxJointDesc::
...
/**
 * Set the attachment point of joint in actor[i]'s space.  idx must be either 0
 * or 1.
 */
void PhysxJointDesc::
