 ...
 * maintain nonpenetration constraints.  You should set the ContactPairFlag
 * CPF_notify_forces in order to receive this value.  @see
 * PhysxScene::set_actor_pair_flag @see PhysxScene::set_actor_group_pair_flag
 */
...
/**
 * Returns the total tangential force that was applied for this pair.  You
 * should set the ContactPairFlag CPF_notify_forces in order to receive this
 * value.  @see PhysxScene::set_actor_pair_flag @see
 ...
 * stream.  This method is a helper for iterating over the pair's contact
 * stream.
 */
...
/**
 * Returns an instance of PhysxContactPoint, which represents a single entry of
 * this pair's contact stream.  This method is a helper for iterating over the
