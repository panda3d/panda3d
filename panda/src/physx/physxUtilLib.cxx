...
/**
 * Test if an oriented box contains a point.  \param [in] box \param [in] p
 */
bool PhysxUtilLib::
...
/**
 * Create an oriented box from an axis aligned box and a transformation.  \param
 * [in] aabb \param [in] mat
 */
 ...
 * (i.e.  a box has 12 edges).  \param [in] box \param [in] edge_index
 */
...
/**
 * Compute a capsule which encloses a box.  \param [in] box
 */
...
/**
 * Test if box A is inside another box B. Returns TRUE if box A is inside box B.
...
/**
 * Compute a box which encloses a capsule.  \param [in] capsule
 */
PhysxBox PhysxUtilLib::
...
/**
 * Compute the distance squared from a point to a ray.  \param [in] ray \param
 * [in] point
 */
float PhysxUtilLib::
...
/**
 * Compute the distance squared from a point to a line segment.  \param [in] seg
 * \param [in] point
 */
float PhysxUtilLib::
...
/**
 * Compute an overall bounding sphere for a pair of spheres.  \param [in]
 * sphere0 \param [in] sphere1
 */
...
/**
 * Get the tangent vectors associated with a normal.  \param [in] n \param [out]
 * t1 \param [out] t2
 */
void PhysxUtilLib::
...
/**
 * Computes mass of a homogeneous sphere according to sphere density.  \param
 * [in] radius \param [in] density
 */
float PhysxUtilLib::
...
/**
 * Computes density of a homogeneous sphere according to sphere mass  \param
 * [in] radius \param [in] mass
 */
float PhysxUtilLib::
...
/**
 * Computes mass of a homogeneous box according to box density.  \param [in]
 * radius \param [in] density
 */
float PhysxUtilLib::
...
/**
 * Computes density of a homogeneous box according to box mass.  \param [in]
 * radius \param [in] mass
 */
float PhysxUtilLib::
...
/**
 * Computes mass of a homogeneous cone according to cone density.  \param [in]
 * radius \param [in] density
 */
float PhysxUtilLib::
...
/**
 * Computes density of a homogeneous cone according to cone mass.  \param [in]
 * radius \param [in] mass
 */
float PhysxUtilLib::
...
/**
 * Computes diagonalized inertia tensor for a box.  \param [in] mass \param [in]
 * xlength \param [in] ylength \param [in] zlength
 */
LVector3f PhysxUtilLib::
...
/**
 * Computes diagonalized inertia tensor for a sphere.  \param [in] mass \param
 * [in] radius \param [in] hollow
 */
LVector3f PhysxUtilLib::
 ...
 * theorem.  Disabling 'full_test' only performs 6 axis tests out of 15.  \param
 * [in] extents0 \param [in] center0 \param [in] rotation0 \param [in] extents1
 * \param [in] center1 \param [in] rotation1 \param [in] full_test
 */
bool PhysxUtilLib::
...
/**
 * Boolean intersection test between a triangle and a box.  \param [in] vertex0
 * \param [in] vertex1 \param [in] vertex2 \param [in] center \param [in]
 * extents
 */
bool PhysxUtilLib::
...
/**
 * Ray-plane intersection test.  \param [in] ray \param [in] plane \param [out]
 * point_on_plane
 */
bool PhysxUtilLib::
...
/**
 * Ray-sphere intersection test.  Returns true if the ray intersects the sphere,
 * and the impact point if needed.  \param [in] origin \param [in] dir \param
 * [in] length \param [in] center \param [in] radius \param [out] hit_pos
 */
bool PhysxUtilLib::
...
/**
 * Segment-AABB intersection test.  Also computes intersection point.  \param
 * [in] p1 \param [in] p2 \param [in] bbox_min \param [in] bbox_max \param [out]
 * intercept
 */
bool PhysxUtilLib::
...
/**
 * Ray-AABB intersection test.  Also computes intersection point.  \param [in]
 * min \param [in] max \param [in] origin \param [in] dir \param [out] coord
 */
bool PhysxUtilLib::
...
/**
 * Boolean ray-OBB intersection test.  Based on separating axis theorem.  \param
 * [in] ray \param [in] center \param [in] extents \param [in] rot
 */
bool PhysxUtilLib::
...
/**
 * Ray-capsule intersection test.  Returns number of intersection points (0,1 or
 * 2) along the ray.  \param [in] origin \param [in] dir \param [in] capsule
 */
 ...
 * linear motion along provided velocity vectors.  \param [in] sphere0 \param
 * [in] velocity0 \param [in] sphere1 \param [in] velocity1
 */
bool PhysxUtilLib::
 ...
 * culling or not according to 'cull'.  \param [in] orig \param [in] dir \param
 * [in] vert0 \param [in] vert1 \param [in] vert2 \param [out] hit, with
 * coordinates (t,u,v) \param [in] cull
 */
bool PhysxUtilLib::
 ...
 * box hit the capsule.  Also returns contact information.  \param [in] box Box
 * \param [in] lss Capsule \param [in] dir Unit-length sweep direction \param
 * [in] length Length of sweep \param [out] normal Normal at impact point
 */
bool PhysxUtilLib::
...
/**
 * Box-vs-sphere sweep test.  Sweeps a box against a sphere, returns true if box
 * hit the sphere.  Also returns contact information.  \param [in] box Box
 * \param [in] sphere Sphere \param [in] dir Unit-length sweep direction \param
 * [in] length Length of sweep \param [out] normal Normal at impact point
 */
bool PhysxUtilLib::
 ...
 * \param [in] lss0 \param [in] lss1 \param [in] dir Unit-length sweep direction
 * \param [in] length Length of sweep \param [out] ip Impact point \param [out]
 * normal Normal at impact point
 */
bool PhysxUtilLib::
 ...
 * true if sphere hit the capsule.  Also returns contact information.  \param
 * [in] sphere \param [in] lss \param [in] dir Unit-length sweep direction
 * \param [in] length Length of sweep \param [out] ip Impact point \param [out]
 * normal Normal at impact point
 */
bool PhysxUtilLib::
 ...
 * the other box.  Also returns contact information.  \param [in] box0 \param
 * [in] box1 \param [in] dir Unit-length sweep direction \param [in] length
 * Length of sweep \param [out] ip Impact point \param [out] normal Normal at
 * impact point
 */
bool PhysxUtilLib::
 ...
 * OBB.  \param [in] point The point \param [in] center OBB center \param [in]
 * extents OBB extents \param [in] rot OBB rotation \param [out] params Closest
 * point on the box, in box space
 */
float PhysxUtilLib::
