...
/**
 * Sets the the material index that designates holes in the height field.  This
 * number is compared directly to sample materials.  Consequently the high 9
 * bits must be zero.  Default value is 0.
 */
void PhysxHeightFieldShapeDesc::
...
/**
 * Sets the high 9 bits of this number are used to complete the material indices
 * in the samples.  The remaining low 7 bits must be zero.  Default value is 0.
 */
void PhysxHeightFieldShapeDesc::
