 ...
 * This method must be called before any calls to set_vertex are done!  The
 * number of vertices in a single convex mesh has to be smaller than 256.
 */
 ...
 * The method iterates over the NodePath geoms and collects data for the convex
 * mesh.  Do not use the following function when using this one: -
 * set_num_vertices - set_vertex
 */
void PhysxConvexMeshDesc::
