...
/**
 * Constructs a ButtonHandle with the corresponding name, which is looked up in
 * the ButtonRegistry.  This exists for the purpose of being able to
 ...
 * ButtonHandle::none() if the button has no alias.  Each button is allowed to
 * have one alias, and multiple different buttons can refer to the same alias.
 * The alias should be the more general name for the button, for instance, shift
 * is an alias for lshift, but not vice-versa.
 */
