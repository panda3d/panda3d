 ...
 * you know the stream in question returns an object of type
 * TypedWritableReferenceCount, allowing for easier reference count management.
 * Note that the caller is still responsible for maintaining the reference count
 * on the return value.
 */
