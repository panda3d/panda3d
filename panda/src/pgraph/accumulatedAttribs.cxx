...
write(ostream &out, int attrib_types, int indent_level) const {
  ...
  if ((attrib_types & SceneGraphReducer::TT_color) != 0) {
    if (_color == (const RenderAttrib *)nullptr) {
  ...
  if ((attrib_types & SceneGraphReducer::TT_color_scale) != 0) {
    if (_color_scale == (const RenderAttrib *)nullptr) {
  ...
  if ((attrib_types & SceneGraphReducer::TT_tex_matrix) != 0) {
    if (_tex_matrix == (const RenderAttrib *)nullptr) {
  ...
  if ((attrib_types & SceneGraphReducer::TT_clip_plane) != 0) {
    if (_clip_plane == (const RenderAttrib *)nullptr) {
  ...
  if ((attrib_types & SceneGraphReducer::TT_cull_face) != 0) {
    if (_cull_face == (const RenderAttrib *)nullptr) {
...
collect(PandaNode *node, int attrib_types) {
  if ((attrib_types & SceneGraphReducer::TT_transform) != 0) {
    ...
    nassertv(_transform != (TransformState *)nullptr);
...
collect(const RenderState *state, int attrib_types) {
  ...
  if ((attrib_types & SceneGraphReducer::TT_color_scale) != 0) {
    ...
    if (node_attrib != (const RenderAttrib *)nullptr) {
      ...
      if (color_scale_override >= _color_scale_override ||
          _color_scale == (const RenderAttrib *)nullptr) {
        if (_color_scale == (const RenderAttrib *)nullptr) {
  ...
  if ((attrib_types & SceneGraphReducer::TT_tex_matrix) != 0) {
    ...
    if (node_attrib != (const RenderAttrib *)nullptr) {
      ...
      if (tex_matrix_override >= _tex_matrix_override ||
          _tex_matrix == (const RenderAttrib *)nullptr) {
        if (_tex_matrix == (const RenderAttrib *)nullptr) {
    ...
    if (tex_attrib != (const RenderAttrib *)nullptr) {
      int texture_override = new_state->get_override(TextureAttrib::get_class_slot());
      if (texture_override >= _texture_override ||
          _texture == (const RenderAttrib *)nullptr) {
        if (_texture == (const RenderAttrib *)nullptr) {
          _texture = tex_attrib;
        } else {
  ...
  if ((attrib_types & SceneGraphReducer::TT_clip_plane) != 0) {
    ...
    if (node_attrib != (const RenderAttrib *)nullptr) {
      ...
      if (clip_plane_override >= _clip_plane_override ||
          _clip_plane == (const RenderAttrib *)nullptr) {
        if (_clip_plane == (const RenderAttrib *)nullptr) {
  ...
  if ((attrib_types & SceneGraphReducer::TT_cull_face) != 0) {
    ...
    if (node_attrib != (const RenderAttrib *)nullptr) {
      ...
      if (cull_face_override >= _cull_face_override ||
          _cull_face == (const RenderAttrib *)nullptr) {
        if (_cull_face == (const RenderAttrib *)nullptr) {
  ...
  if ((attrib_types & SceneGraphReducer::TT_other) != 0) {
    ...
    nassertr(_other != (RenderState *)nullptr, new_state);
...
apply_to_node(PandaNode *node, int attrib_types) {
  ...
  if ((attrib_types & SceneGraphReducer::TT_color) != 0) {
    if (_color != (RenderAttrib *)nullptr) {
      const RenderAttrib *node_attrib =
        node->get_attrib(ColorAttrib::get_class_slot());
      if (node_attrib != (RenderAttrib *)nullptr) {
        node->set_attrib(_color->compose(node_attrib)->get_unique());
      } else {
        node->set_attrib(_color->get_unique());
      }
      _color = (RenderAttrib *)nullptr;
    }
  }

  if ((attrib_types & SceneGraphReducer::TT_color_scale) != 0) {
    if (_color_scale != (RenderAttrib *)nullptr) {
      const RenderAttrib *node_attrib =
      ...
      _color_scale = (RenderAttrib *)nullptr;
    }
  }

  if ((attrib_types & SceneGraphReducer::TT_tex_matrix) != 0) {
    if (_tex_matrix != (RenderAttrib *)nullptr) {
      const RenderAttrib *node_attrib =
      ...
      _tex_matrix = (RenderAttrib *)nullptr;
    }
  }

  if ((attrib_types & SceneGraphReducer::TT_clip_plane) != 0) {
    if (_clip_plane != (RenderAttrib *)nullptr) {
      const RenderAttrib *node_attrib =
      ...
      _clip_plane = (RenderAttrib *)nullptr;
    }
  }

  if ((attrib_types & SceneGraphReducer::TT_cull_face) != 0) {
    if (_cull_face != (RenderAttrib *)nullptr) {
      const RenderAttrib *node_attrib =
      ...
      _cull_face = (RenderAttrib *)nullptr;
    }
  }
