...
/**
 * Constructs a new RescaleNormalAttrib object that specifies whether to rescale
 * normals to compensate for transform scales or incorrectly defined normals.
 */
 ...
 * the other one.  This should return 0 if the two RescaleNormalAttrib objects
 * are equivalent, a number less than zero if this one should be sorted before
 * the other one, and a number greater than zero otherwise.  This will only be
 * called with two RescaleNormalAttrib objects whose get_type() functions return
 * the same.
 */
 ...
 * RescaleNormalAttrib is encountered in the Bam file.  It should create the
 * RescaleNormalAttrib and extract its information from the file.
 */
