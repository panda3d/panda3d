...
/**
 * Intended to be overridden by derived DepthTestAttrib types to return a unique
 * number indicating whether this DepthTestAttrib is equivalent to the other
 * one.  This should return 0 if the two DepthTestAttrib objects are equivalent,
 ...
 * DepthTestAttrib objects whose get_type() functions return the same.
 */
int DepthTestAttrib::
 ...
 * DepthTestAttrib is encountered in the Bam file.  It should create the
