 ...
 * other one.  This should return 0 if the two ShadeModelAttrib objects are
 ...
 * called with two ShadeModelAttrib objects whose get_type() functions return
 * the same.
 */
 ...
 * ShadeModelAttrib is encountered in the Bam file.  It should create the
