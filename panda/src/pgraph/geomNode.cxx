  ...
  OPEN_ITERATE_CURRENT_AND_UPSTREAM(_cycler, current_thread) {
    ...
    for (size_t i = 0; i < num_geoms; ++i) {
      ...
      if ((attrib_types & SceneGraphReducer::TT_color) != 0) {
        ...
        if (ra != (const RenderAttrib *)nullptr) {
      ...
      if ((attrib_types & SceneGraphReducer::TT_color_scale) != 0) {
        if (geom_attribs._color_scale != (const RenderAttrib *)nullptr) {
      ...
      if ((attrib_types & SceneGraphReducer::TT_tex_matrix) != 0) {
        if (geom_attribs._tex_matrix != (const RenderAttrib *)nullptr) {
          ...
          if (geom_attribs._texture != (RenderAttrib *)nullptr) {
      ...
      if ((attrib_types & SceneGraphReducer::TT_cull_face) != 0) {
        if (geom_attribs._cull_face != (const RenderAttrib *)nullptr) {
...
add_geom(Geom *geom, const RenderState *state) {
  nassertv(geom != (Geom *)nullptr);
  nassertv(geom->check_valid());
  nassertv(state != (RenderState *)nullptr);
