 ...
 * the light's color.  The default value is 6500 K, corresponding to a perfectly
 * white light assuming a D65 white point.
 */
void Light::
 ...
 * falloff from the center of the spotlight.  For other kinds of lights, returns
 * 0.
 */
PN_stdfloat Light::
get_exponent() const {
...
/**
 * Returns the color of specular highlights generated by the light.  This value
 * is meaningless for ambient lights.
 */
const LColor &Light::
...
/**
 * Returns a GeomNode that may be rendered to visualize the Light.  This is used
 * during the cull traversal to render the Lights that have been made visible.
 */
GeomNode *Light::
get_viz() {
