...
/**
 * Removes the indicated InternalName from the collection.  Returns true if the
 * name was removed, false if it was not a member of the collection.
 */
...
/**
 * Returns true if the indicated InternalName appears in this collection, false
 * otherwise.
 */
bool InternalNameCollection::
...
/**
 * Writes a complete multi-line description of the InternalNameCollection to the
 * indicated output stream.
 */
void InternalNameCollection::
