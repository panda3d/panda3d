 ...
 * number indicating whether this ScissorAttrib is equivalent to the other one.
 ...
 * ScissorAttrib objects whose get_type() functions return the same.
 */
int ScissorAttrib::
 ...
 * ScissorAttrib is encountered in the Bam file.  It should create the
