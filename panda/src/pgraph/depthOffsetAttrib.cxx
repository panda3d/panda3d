...
/**
 * Constructs a new DepthOffsetAttrib object that indicates the relative amount
 * of bias to write to the depth buffer for subsequent geometry.
 */
 ...
 * values to write to the depth buffer, in the range 0 .. 1.  This range is 0, 1
 * by default; setting it to some other range can be used to create additional
 ...
 * unique number indicating whether this DepthOffsetAttrib is equivalent to the
 * other one.  This should return 0 if the two DepthOffsetAttrib objects are
 ...
 * called with two DepthOffsetAttrib objects whose get_type() functions return
 * the same.
 */
 ...
 * DepthOffsetAttrib is encountered in the Bam file.  It should create the
 * DepthOffsetAttrib and extract its information from the file.
 */
