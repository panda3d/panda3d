...
/**
 * Intended to be overridden by derived DecalEffect types to return a unique
 * number indicating whether this DecalEffect is equivalent to the other one.
 * This should return 0 if the two DecalEffect objects are equivalent, a number
 ...
 * DecalEffect objects whose get_type() functions return the same.
 */
int DecalEffect::
 ...
 * DecalEffect is encountered in the Bam file.  It should create the DecalEffect
 ...
 * relevant data from the BamFile for the new DecalEffect.
 */
void DecalEffect::
