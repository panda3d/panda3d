...
/**
 * Constructs a new AudioVolumeAttrib object that indicates audio volume should
 * be scaled by the indicated factor.
 */
CPT(RenderAttrib) AudioVolumeAttrib::
...
/**
 * Constructs a new AudioVolumeAttrib object that ignores any AudioVolumeAttrib
 * inherited from above.  You may also specify an additional volume scale to
 * apply to geometry below (using set_volume()).
 */
CPT(RenderAttrib) AudioVolumeAttrib::
make_off() {
 ...
 * unique number indicating whether this AudioVolumeAttrib is equivalent to the
 * other one.  This should return 0 if the two AudioVolumeAttrib objects are
 ...
 * called with two AudioVolumeAttrib objects whose get_type() functions return
 * the same.
 */
 ...
 * AudioVolumeAttrib is encountered in the Bam file.  It should create the
 * AudioVolumeAttrib and extract its information from the file.
 */
