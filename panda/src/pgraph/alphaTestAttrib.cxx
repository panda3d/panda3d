...
/**
 * Intended to be overridden by derived AlphaTestAttrib types to return a unique
 * number indicating whether this AlphaTestAttrib is equivalent to the other
 * one.  This should return 0 if the two AlphaTestAttrib objects are equivalent,
 ...
 * AlphaTestAttrib objects whose get_type() functions return the same.
 */
int AlphaTestAttrib::
 ...
 * AlphaTestAttrib is encountered in the Bam file.  It should create the
