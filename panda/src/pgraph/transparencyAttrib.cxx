 ...
 * unique number indicating whether this TransparencyAttrib is equivalent to the
 * other one.  This should return 0 if the two TransparencyAttrib objects are
 ...
 * called with two TransparencyAttrib objects whose get_type() functions return
 * the same.
 */
 ...
 * TransparencyAttrib is encountered in the Bam file.  It should create the
 * TransparencyAttrib and extract its information from the file.
 */
