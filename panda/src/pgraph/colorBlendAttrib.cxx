 ...
 * other one.  This should return 0 if the two ColorBlendAttrib objects are
 ...
 * called with two ColorBlendAttrib objects whose get_type() functions return
 * the same.
 */
 ...
 * ColorBlendAttrib is encountered in the Bam file.  It should create the
