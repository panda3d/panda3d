...
/**
 * This tests the transform to make sure it's within the specified limits.  It's
 * done so we can assert to see when an invalid transform is being applied.
 */
void ModelNode::
...
/**
 * node hook.  This function handles outside (non-physics) actions on the actor
 * and updates the internal representation of the node.  i.e.  copy from
 ...
 * ModelNode is encountered in the Bam file.  It should create the ModelNode and
