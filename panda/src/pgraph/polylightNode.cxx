...
/**
 * Returns a number less than zero if this PolylightNode sorts before the other
 * one, greater than zero if it sorts after, or zero if they are equivalent.
 * Two PolylightNodes are considered equivalent if they consist of exactly the
 * same properties Otherwise, they are different; different PolylightNodes will
 * be ranked in a consistent but undefined ordering; the ordering is useful only
 * for placing the PolylightNodes in a sorted container like an STL set.
 */
int PolylightNode::
 ...
 * CompassEffect is encountered in the Bam file.  It should create the
