 ...
 * other one.  This should return 0 if the two ColorWriteAttrib objects are
 ...
 * called with two ColorWriteAttrib objects whose get_type() functions return
 * the same.
 */
 ...
 * ColorWriteAttrib is encountered in the Bam file.  It should create the
