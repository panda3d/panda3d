...
/**
 * Constructs a new CullBinAttrib assigning geometry into the named bin.  If the
 * bin name is the empty string, the default bin is used.  The draw_order
 * specifies further ordering information which is relevant only to certain
 * kinds of bins (in particular CullBinFixed type bins).
 */
 ...
 * number indicating whether this CullBinAttrib is equivalent to the other one.
 ...
 * CullBinAttrib objects whose get_type() functions return the same.
 */
int CullBinAttrib::
 ...
 * CullBinAttrib is encountered in the Bam file.  It should create the
