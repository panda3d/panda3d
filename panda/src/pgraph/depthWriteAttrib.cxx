 ...
 * other one.  This should return 0 if the two DepthWriteAttrib objects are
 ...
 * called with two DepthWriteAttrib objects whose get_type() functions return
 * the same.
 */
 ...
 * DepthWriteAttrib is encountered in the Bam file.  It should create the
