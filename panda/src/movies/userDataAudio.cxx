 ...
 * stored little-endian in the string.  This is not particularly efficient, but
 * it may be convenient to deal with samples in python.
 */
void UserDataAudio::
...
/**
 * Promises not to append any more samples, ie, this marks the end of the audio
 * stream.
 */
void UserDataAudio::
done() {
