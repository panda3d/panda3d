 ...
 * subset (unless a lower node is also listed in the exclude list).  Since the
 * name is a GlobPattern, it may of course include filename globbing characters
 * like * and ?.
 */
void PartSubset::
...
/**
 * Adds the named joint to the list of joints that will be explicitly exlcluded
 * from the subset.  Any joint at or below a named node will not be included in
 * the subset (unless a lower node is also listed in the include list).  Since
 * the name is a GlobPattern, it may of course include filename globbing
 * characters like * and ?.
 */
void PartSubset::
...
/**
 * Appends the include and exclude list from the other object onto this object's
 * lists.
 */
void PartSubset::
...
/**
 * Returns true if the include list is completely empty, false otherwise.  If it
 * is empty, it is the same thing as including all joints.
 */
bool PartSubset::
...
/**
 * Returns true if the indicated name matches a name on the include list, false
 * otherwise.
 */
bool PartSubset::
...
/**
 * Returns true if the indicated name matches a name on the exclude list, false
 * otherwise.
 */
bool PartSubset::
