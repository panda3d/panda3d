 ...
 * without a parent.  To create an AnimChannel hierarchy, you must first create
 * an AnimBundle, and use that to create any subsequent children.
 */
AnimGroup::
...
/**
 * Creates the AnimGroup, and adds it to the indicated parent.  The only way to
