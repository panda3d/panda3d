...
/**
 * Creates the PartGroup, and adds it to the indicated parent.  The only way to
 * delete it subsequently is to delete the entire hierarchy.
 */
PartGroup::
 ...
 * otherwise.  This is normally only called internally by
 * PartBundle::freeze_joint(), but you may also call it directly.
 */
bool PartGroup::
 ...
 * controlled, false otherwise.  This is normally only called internally by
 * PartBundle::control_joint(), but you may also call it directly.
 */
bool PartGroup::
 ...
 * Returns true if the joint was modified, false otherwise.  This is normally
 * only called internally by PartBundle::release_joint(), but you may also call
 * it directly.
 */
bool PartGroup::
...
/**
 * Writes a brief description of the group, showing its current value, and that
 ...
 * This is provided to allow a bit of run-time checking that joints and channels
 * are matching properly in type.
 */
 ...
 * returns true if the hierarchies match, false otherwise.  If
 * hierarchy_match_flags is 0, only an exact match is accepted; otherwise, it
 * may contain a union of PartGroup::HierarchyMatchFlags values indicating
