...
/**
 * Returns the AnimChannelBase that has been forced to this joint by a previous
 * call to apply_freeze() or apply_control(), or NULL if no such channel has
 * been applied.
 */
 ...
 * directly; it is called from the top of the tree by PartBundle::update().  The
 * return value is true if any part has changed, false otherwise.
 */
bool MovingPartBase::
 ...
 * as a result of the update, or false otherwise.
 */
bool MovingPartBase::
 ...
 * Available index numbers are the elements of the holes set, as well as next to
 * infinity.
 */
void MovingPartBase::
...
/**
 * Similar to bind_hierarchy, but does not actually perform any binding.  All it
 * does is compute the BitArray bount_joints according to the specified subset.
 * This is useful in preparation for asynchronous binding--in this case, we may
 * need to know bound_joints immediately, without having to wait for the
 * animation itself to load and bind.
 */
void MovingPartBase::
