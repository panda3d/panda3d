...
/**
 * Removes the nth animation records from the table.  This renumbers indexes for
 ...
 * this name, no operation is performed (the original record is unchanged).  See
 * find_anim().  This will invalidate existing index numbers.
 */
void AnimPreloadTable::
...
/**
 * Copies the animation records from the other table into this one.  If a given
 * record name exists in both tables, the record in this one supercedes.
 */
void AnimPreloadTable::
