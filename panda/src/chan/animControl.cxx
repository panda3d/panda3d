...
/**
 * Specifies an event name that will be thrown when the AnimControl is finished
 * binding asynchronously.  If the AnimControl has already finished binding, the
