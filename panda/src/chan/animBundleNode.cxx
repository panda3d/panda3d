...
/**
 * Recursively walks the scene graph beginning at the indicated node (which need
 * not be an AnimBundleNode), and returns the first AnimBundle found.  Returns
 * NULL if no AnimBundle can be found.
 */
 ...
 * type is encountered in the Bam file.  It should create the object and extract
