    ...
    def __init__(self,pos,offset,colors,rows_collums=(5,1)):
        ...
        while x_i < x:
            ...
            while y_i < y:
                ...
                frame=construct_frame(pos_i,grid_pos=(x_i,y_i),color=col_i,drag_drop_type=col_key)
    ...
    def __init__(self,pos,offset,rows_collums=(3,3)):
        ...
        while x_i < x:
            ...
            while y_i < y:
                ...
                pos_i=(pos[0]+offset[0]*x_i,pos[1]+offset[1]*y_i)
                frame=construct_frame(pos_i,grid_pos=(x_i,y_i),drag_drop_type=dd_type)
...
def construct_frame(pos,grid_pos=(0,0),frame_kwargs={},color=(1,1,1,1.0),drag_drop_type=None):
