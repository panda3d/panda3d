...
# TODO
# * Make device output on console optional
# * Maybe use base2d instead of aspect2d?
# * Draw more stylesheet data out of DirectGui elements
# * Battery support
#   * device.has_battery()
#   * device.get_battery_level()
#   * device.get_max_battery_level()
# * tracker support
#   BLOCKED: There's no tracker support except on rdb's machine
#   * device.has_tracker()
#   * device.get_tracker()
# * Diverse FIXMEs
