...
# Date: 2019-06-21
#
# This module contains a class to generate cylinder primitives, as well as a
# function to create cylinders gradually over time.
...
def build_cylinder(radius, height, segments):
    """
    Gradually build up a cylinder, one polygon at a time.
    Please note that this is a generator function, whose main purpose is to
    show the creation of a cylinder over time. As such, it doesn't offer as many
    creation options as the CylinderMaker class, which should be preferred
    ...
    if segs_cap > 0:
        ...
        for i in range(1, segs_c):
            ...
            if model_initialized:
                ...
                model = init_model("cylinder", vertex_count, values, indices)
    ...
    for i in range(segs_a + 1):
        ...
        # Define the vertex order of the mantle triangles
