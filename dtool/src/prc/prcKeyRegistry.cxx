...
/**
 * Records the list of public keys that are compiled into this executable.  The
 * pointer is assumed to be to an area of static memory that will not be
 ...
 * ownership is transferred to the registry and it will eventually be freed via
 * EVP_PKEY_free().
 */
void PrcKeyRegistry::
