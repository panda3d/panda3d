...
/**
 * LittleEndian is a special class that automatically reverses the byte-order of
 * numeric values for big-endian machines, and passes them through unchanged for
