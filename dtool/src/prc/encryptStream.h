 ...
 * source stream on-the-fly.  Attach an IDecryptStream to an existing istream
 * that provides encrypted data, as generated by an OEncryptStream, and read the
 * corresponding unencrypted data from the IDecryptStream.  Seeking is not
 * supported.
 */
 ...
 * destination stream on-the-fly.  Attach an OEncryptStream to an existing
 * ostream that will accept encrypted data, and write your unencrypted source
 * data to the OEncryptStream.  Seeking is not supported.
 */
