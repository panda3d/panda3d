 ...
 * time, for the purpose of synchronizing the time stamps in the log messages of
...
/**
 * Returns the name of the config variable that controls this category.  This is
...
/**
 * Returns the value of the check-debug-notify-protect ConfigVariable.  This is
 * defined using a method accessor rather than a static ConfigVariableBool, to
 * protect against the variable needing to be accessed at static init time.
 */
bool NotifyCategory::
