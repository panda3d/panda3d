...
/**
 * This is a generic, untyped ConfigVariable.  It is also the base class for the
 * typed ConfigVariables, and contains all of the code common to ConfigVariables
 * of all types (except ConfigVariableList, which is a bit of a special case).
 * Mostly, this class serves as a thin wrapper around ConfigVariableCore and/or
 * ConfigDeclaration, more or less duplicating the interface presented there.
 */
