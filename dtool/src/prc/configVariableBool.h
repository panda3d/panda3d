...
PUBLISHED:
  ...
  INLINE explicit ConfigVariableBool(const std::string &name, bool default_value,
                                     const std::string &description = std::string(), int flags = 0);
  INLINE explicit ConfigVariableBool(const std::string &name, const std::string &default_value,
                                     const std::string &description = std::string(), int flags = 0);
