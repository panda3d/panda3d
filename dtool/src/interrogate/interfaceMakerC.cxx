 ...
 * type.  If struct_type is non-NULL, it is the type of the enclosing class for
 * the function (method) in question.  The return value is a newly-allocated
 * ParameterRemap object, if the parameter type is acceptable, or NULL if the
