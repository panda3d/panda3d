...
/**
 * A base class for several different remapping types that convert to an atomic
 * string class.  The atomic string class is represented in the C interface as a
 * (const char *).  Other interfaces may be able to represent it differently,
 ...
 * A base class for several different remapping types that convert to an atomic
 * string class.  The atomic string class is represented in the C interface as a
 * (const wchar_t *).  Other interfaces may be able to represent it differently,
 * subverting the code defined here.
 */
