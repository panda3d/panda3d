 ...
 * protocols this object appears to support (based on the methods it provides).
 */
 ...
 * method, false if it is an instance method.  This does not test all overloads
 * of the indicated name, merely the first one found.
 */
...
/**
 * This method should be overridden and redefined to return false for interfaces
 * that don't support global functions and should therefore will only accept
 * function remaps that have a class associated.
 */
bool InterfaceMaker::
...
/**
 * Fills up the indicated vector with all of the FunctionRemap pointers created
 * by this InterfaceMaker.  It is the user's responsibility to empty the vector
 * before calling this function; the new pointers will simply be added to the
 * end.
 */
void InterfaceMaker::
 ...
 * each FunctionRemap object (i.e.  for each instance of an overloaded function)
 * need not define a name here.
 */
 ...
 * for the function, just before we return it.  Returns the string representing
 * the new return value after processing.
 */
string InterfaceMaker::
...
/**
 * Cleans up the given return value by deleting it or decrementing its reference
...
/**
 * Outputs the code to increment the reference count for the indicated variable
 * name.
 */
void InterfaceMaker::
...
/**
 * Outputs the code to decrement the reference count for the indicated variable
 * name.
 */
void InterfaceMaker::
...
/**
 * Generates a unique string that corresponds to the function signature for the
 * indicated FunctionRemap object, and stores the generated string in the _hash
