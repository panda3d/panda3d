...
PUBLISHED:
  ...
  INLINE string get_name(TypedObject *object = (TypedObject *)nullptr) const;
  INLINE bool is_derived_from(TypeHandle parent,
                              TypedObject *object = (TypedObject *)nullptr) const;

  INLINE int get_num_parent_classes(TypedObject *object = (TypedObject *)nullptr) const;
  INLINE TypeHandle get_parent_class(int index) const;

  INLINE int get_num_child_classes(TypedObject *object = (TypedObject *)nullptr) const;
