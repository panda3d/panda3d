...
/**
 * Returns true if the type is a special parameter expression type.  This sort
 * of type is created to handle instance declarations that initially look like
 * function prototypes.
 */
bool CPPType::
 ...
 * are alternate typedef names.  This list might be empty, or it might be long.
 * One of these names may or may not be the same as the "preferred" name.
 */
int CPPType::
 ...
 * object has previously been created; if it has, it returns the old object and
 * deletes the new one.  Otherwise, it stores the new one and returns it.
 */
CPPType *CPPType::
...
/**
 * Records a global typedef name associated with the indicated Type.  This will
 * be an "alt" name, and it may also become the "preferred" name.
 */
void CPPType::
