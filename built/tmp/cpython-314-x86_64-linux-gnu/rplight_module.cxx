...
#line 3884 "built/tmp/cpython-314-x86_64-linux-gnu/rplight_module.cxx"
extern const struct LibraryDef libp3rplight_moddef;
extern void Dtool_libp3rplight_RegisterTypes();
extern void Dtool_libp3rplight_BuildInstants(PyObject *module);
...
#if PY_MAJOR_VERSION >= 3
extern "C" EXPORT_INIT_FUNC PyObject *PyInit__rplight();
#else
extern "C" EXPORT_INIT_FUNC void init_rplight();
#endif

#if PY_MAJOR_VERSION >= 3
static struct PyModuleDef py__rplight_module = {
...
PyObject *PyInit__rplight() {
  PyImport_Import(PyUnicode_FromString("panda3d.core"));
  Dtool_libp3rplight_RegisterTypes();

  const LibraryDef *defs[] = {&libp3rplight_moddef, nullptr};

  PyObject *module = Dtool_PyModuleInitHelper(defs, &py__rplight_module);
  if (module != nullptr) {
    Dtool_libp3rplight_BuildInstants(module);
  }
  return module;
}
...
void init_rplight() {
  ...
  PyObject *module = Dtool_PyModuleInitHelper(defs, "panda3d._rplight");
  if (module != nullptr) {
    Dtool_libp3rplight_BuildInstants(module);
  }
}
