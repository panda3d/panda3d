...
PkgListSet(["PYTHON", "DIRECT",                        # Python support
  ...
  "OPENAL", "FMODCORE",                                # Audio playback
...
if (COMPILER=="GCC"):
    ...
    SmartPkgEnable("FMODCORE",  "",          ("fmod"), ("fmod", "fmod/fmod.h"))
...
if PkgSkip("FMODCORE") == 0:
  OPTS=['DIR:panda/src/audiotraits', 'BUILDING:FMOD_AUDIO',  'FMODCORE']
  ...
  TargetAdd('libp3fmod_audio.dll', opts=['MODULE', 'ADVAPI', 'WINUSER', 'WINMM', 'FMODCORE'])
