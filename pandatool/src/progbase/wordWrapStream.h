 ...
 * output messages to fit the terminal width.  By convention (inherited from
 * show_text), a newline written to the WordWrapStream indicates a paragraph
 * break, and is generally printed as a blank line.  To force a line break
 * without a paragraph break, use '\r'.
 */
