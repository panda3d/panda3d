...
/**
 * Sets the egg data that will be filled in when convert_file() is called.  This
 * must be called before convert_file().
 */
 ...
 * by get_extension(), that are recognized by this converter.
 */
 ...
 * parented to egg_parent.  The parameters orig_filename and searchpath are as
 * those passed to convert_model_path().  Returns true on success, false on
 * failure.
 */
bool SomethingToEggConverter::
