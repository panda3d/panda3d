 ...
 * Later, we'll need this information: if a node is referenced at least once, we
 * need to define it as an instance node.
 */
 ...
 * This create the group and does any instance-munging necessary, then calls the
 * indicated method with the new parameters.
 */
void VRMLToEggConverter::
...
/**
 * Creates an Egg group corresponding a VRML shape.  This will probably contain
 * a vertex pool and a number of polygons.
 */
void VRMLToEggConverter::
