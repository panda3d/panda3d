 ...
 * and stores them as the children.  Returns true if successful (and exactly the
 * correct number of bytes were read), or false otherwise.
 */
bool LwoGroupChunk::
...
/**
 * Formats the list of chunks for output to the user (primarily for debugging),
 * one per line.
 */
void LwoGroupChunk::
