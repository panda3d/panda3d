...
/**
 * Returns the name of the texture's associated .attr file.  This contains some
 * additional MultiGen information about the texture parameters.  This is, of
 * course, just the name of the texture with .attr appended.  Normally, it won't
 * be necessary to access this file directly; you can call read_attr_data() or
 * write_attr_data() to get at the data stored in this file.  (And
 * read_attr_data() is called automatically when the Flt file is read in.)
 */
Filename FltTexture::
 ...
 * automatically, according to the setting of FltHeader::set_auto_attr_update().
 */
FltError FltTexture::
