...
/**
 * Defines the transform explicitly.  The angle of rotation is determined by the
 * angle between the reference point and the to point (relative to the center),
 * and the scale factor is determined by the distance between the reference
 * point and the center point.  If axis_scale is true, the scale is along
 * reference point axis only; otherwise, it is a uniform scale.
 */
