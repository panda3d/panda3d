...
/**
 * Returns the y position of the indicated label's bottom edge, relative to the
 * label stack's parent window.
 */
int WinStatsLabelStack::
...
/**
 * Draws a highlight around the label representing the indicated collector, and
 * removes the highlight from any other label.  Specify -1 to remove the
