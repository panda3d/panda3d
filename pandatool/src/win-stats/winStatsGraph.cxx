...
/**
 * Changes the pause flag for the graph.  When this flag is true, the graph does
 * not update in response to new data.
 */
void WinStatsGraph::
...
/**
 * Should be called when the user closes the associated window.  This tells the
 * monitor to remove the graph.
 */
void WinStatsGraph::
close() {
 ...
 * draggable things the mouse might be hovering over and return the appropriate
...
/**
 * Repositions the graph child window within the parent window according to the
 * _margin variables.
 */
void WinStatsGraph::
