...
/**
 * Associates the indicated VertexMap with the points set.  This may define such
 * niceties as UV coordinates or per-vertex color.
 */
void CLwoPoints::
 ...
 * vertex, false otherwise.  If true, fills in uv with the value.
 */
bool CLwoPoints::
