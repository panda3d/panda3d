...
public:
  ...
  EggXfmSAnim *get_table(std::string_view joint_name) const;
...
private:
  ...
  typedef pmap<std::string, FrameData, std::less<>> JointData;
  ...
  typedef pmap<std::string, TablePair, std::less<>> Tables;
  Tables _tables;
};
