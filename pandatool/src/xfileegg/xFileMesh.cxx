...
/**
 * Creates a new XFileMaterial, if one does not already exist for the indicated
 * material, and returns its index.
 */
int XFileMesh::
...
/**
 * Adds the newly-created XFileMaterial unequivocally to the mesh, returning its
 * index number.  The XFileMesh object becomes the owner of the XFileMaterial
 * pointer, and will delete it when it destructs.
 */
int XFileMesh::
...
/**
 * Specifies the egg node that will eventually be the parent of this mesh, when
 * create_polygons() is later called.
 */
void XFileMesh::
...
/**
 * Returns true if any of the vertices or faces added to this mesh used a color,
 * false otherwise.
 */
bool XFileMesh::
has_colors() const {
