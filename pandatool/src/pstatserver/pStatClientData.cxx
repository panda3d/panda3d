...
/**
 * Returns true if the data is actively getting filled by a connected client, or
 * false if the client has terminated.
 */
 ...
 * whether it should appear on the Levels menu).  The return value is true if
...
/**
 * Returns whether the given collector has level data (and consequently, whether
 * it should appear on the Levels menu).
 */
bool PStatClientData::
...
/**
 * Returns the collector index of the nth toplevel collector.  Use this function
 * to iterate through the n toplevel collectors indicated by
...
/**
 * Returns true if the indicated thread has been defined by the client already,
 * false otherwise.  It is possible for the client to start streaming data
 ...
 * Collector in the relationship graph.  If child is the same as parent, returns
 * zero.  If child is an immediate child of parent, returns 1.  If child is a
 * grandchild of parent, returns 2, and so on.  If child is not a descendant of
 * parent at all, returns -1.
 */
int PStatClientData::
 ...
 * information just arrived from the client.  The pointer will become owned by
 * the PStatClientData object and will be freed on destruction.
 */
void PStatClientData::
...
/**
 * Adds a new thread definition to the dataset.  Presumably this is information
 ...
 * particular thread (which may or may not have already been defined).  The
 * pointer will become owned by the PStatThreadData object and will be freed on
 * destruction.
 */
void PStatClientData::
