...
/**
 * This class is used internally to build up the set of color bars defined by a
...
/**
 * Makes sure that each start-bar data point was matched by a corresponding end-
 * bar data point.
 */
void PStatPianoRoll::BarBuilder::
finish(double time) {
 ...
 * necessary after the bars have been redrawn.
 */
void PStatPianoRoll::
idle() {
}
