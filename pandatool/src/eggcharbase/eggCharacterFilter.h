 ...
 * character models and their associated animation files together.  It reads in
 * a number of egg files, any combination of model files or character files
 * which must all represent the same character skeleton, and maintains a single
 * hierarchy of joints and sliders that may be operated on before writing the
 * files back out.
 */
