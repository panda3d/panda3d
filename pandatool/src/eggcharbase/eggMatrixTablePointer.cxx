...
get_frame_rate() const {
  if (_xform == (EggXfmSAnim *)nullptr || !_xform->has_fps()) {
    return 0.0;
  } else {
...
extend_to(int num_frames) {
  nassertv(_xform != (EggXfmSAnim *)nullptr);
  _xform->normalize();
