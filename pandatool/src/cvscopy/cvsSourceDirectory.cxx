...
/**
 * Returns the relative pathname to this particular directory, as seen from the
 * root of the tree.
 */
Filename CVSSourceDirectory::
get_path() const {
...
/**
 * Returns the source directory that corresponds to the given relative path from
 * this directory, or NULL if there is no match.
 */
CVSSourceDirectory *CVSSourceDirectory::
...
/**
 * Recursively scans the contents of the source directory.  Fullpath is the full
 * path name to the directory; key_filename is the name of a file that must
 * exist in each subdirectory for it to be considered part of the hierarchy.
