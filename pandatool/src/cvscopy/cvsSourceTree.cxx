 ...
 * the root, or NULL if there is no match.  The relative path may or may not
...
/**
 * Temporarily changes the current directory to the named path.  Returns true on
 * success, false on failure.  Call restore_cwd() to restore to the original
 * directory later.
 */
bool CVSSourceTree::
