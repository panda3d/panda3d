  ...
  _parent(parent)
{
  ...
  if (_parent != (MayaNodeDesc *)nullptr) {
...
bool MayaNodeDesc::
has_dag_path() const {
  return (_dag_path != (MDagPath *)nullptr);
}
...
get_dag_path() const {
  nassertr(_dag_path != (MDagPath *)nullptr, *_dag_path);
  return *_dag_path;
}
...
has_object_type(string object_type) const {
  bool ret = false;
  if ((_egg_group != (EggGroup*) nullptr)
