 ...
 * Maya file, or from the data already in the global Maya model space.  Note
 * that since the Maya API presents just one global model space, it is not
 * possible to simultaneously load two distinct Maya files.
 */
