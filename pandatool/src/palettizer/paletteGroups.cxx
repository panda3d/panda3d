...
/**
 * Computes the intersection of PaletteGroups a and b, and stores the result in
 * this object.  The result may be the same object as either a or b.
 */
void PaletteGroups::
...
/**
 * Removes the special "null" group from the set.  This is a special group that
 * egg files may be assigned to, but which textures never are; it indicates that
 * the egg file should not influence the palette assignment.
 */
void PaletteGroups::
remove_null() {
  Groups::iterator gi;
