...
/**
 * Returns the base part of the filename.  This is everything before the version
 * number.
 */
const string &SoftFilename::
get_base() const {
 ...
 * together, ignoring extension; and within files with the same base, files are
 * sorted in decreasing version number order so that the most recent version
 * appears first.
 */
bool SoftFilename::
...
/**
 * Sets the flag that indicates whether this file should be entered into the CVS
 * database.
 */
void SoftFilename::
