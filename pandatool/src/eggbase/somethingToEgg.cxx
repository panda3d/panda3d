 ...
 * egg file.  This is normally done automatically when the file is written out.
 */
void SomethingToEgg::
...
/**
 * Copies the relevant parameters specified by the user on the command line (if
 * add_path_replace_options(), add_path_store_options(), or
