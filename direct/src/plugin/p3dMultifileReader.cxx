 ...
 * failure.  Upates the "step" object with the progress through this operation.
 */
bool P3DMultifileReader::
...
/**
 * Assuming the file stream is positioned at the first record, reads all of the
 * records into the _subfiles list.  Returns true on success, false on failure.
 */
bool P3DMultifileReader::
read_index() {
  _last_data_byte = 0;
