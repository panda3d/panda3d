...
/**
 * Records the DCTypedef object that generated this parameter.  This is normally
 * called only from DCTypedef::make_new_parameter().
 */
void DCParameter::
...
/**
 * Returns the type represented by this_type[size].  In the case of a generic
 * DCParameter, this means it returns a DCArrayParameter wrapped around this
 * type.
 */
DCParameter *DCParameter::
