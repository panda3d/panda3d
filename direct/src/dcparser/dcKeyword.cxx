...
/**
 * Returns the bitmask associated with this keyword, if any.  This is the value
 * that was historically associated with this keyword, and was used to generate
 * a hash code before we had user-customizable keywords.  It will return ~0 if
 * this is not an historical keyword.
 */
int DCKeyword::
