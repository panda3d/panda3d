...
/**
 * Returns the nth atomic field that makes up this molecular field.  This may or
 * may not be a field of this particular class; it might be defined in a parent
 * class.
 */
...
/**
 * Adds the indicated atomic field to the end of the list of atomic fields that
 * make up the molecular field.  This is normally called only during parsing of
 * the dc file.  The atomic field should be fully defined by this point; you
 * should not modify the atomic field (e.g.  by adding more elements) after
