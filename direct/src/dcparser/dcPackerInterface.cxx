...
/**
 * Returns the index number to be passed to a future call to DCPacker::seek() to
 * seek directly to the named field without having to look up the field name in
 * a table later, or -1 if the named field cannot be found.  If the named field
 * is nested within a switch or some similar dynamic structure that reveals
 * different fields based on the contents of the data, this mechanism cannot be
 * used to pre-fetch the field index number--you must seek for the field by
 * name.
 */
...
/**
 * Returns true if this interface is bitwise the same as the interface described
 * with the indicated formatted string, e.g.  "(uint8, uint8, int16)", or false
 * otherwise.  If DCFile is not NULL, it specifies the DCFile that was
 * previously loaded, from which some predefined structs and typedefs may be
 * referenced in the description string.
 */
 ...
 * this is called to confirm that the number of nested fields that were added is
 * valid for this type.  This is primarily useful for array types with dynamic
 * ranges that can't validate the number of fields any other way.
 */
bool DCPackerInterface::
...
/**
 * Packs the field's specified default value (or a sensible default if no value
 * is specified) into the stream.  Returns true if the default value is packed,
 * false if the field doesn't know how to pack its default value.
 */
bool DCPackerInterface::
