...
/**
 * The DCTypedef object becomes the owner of the supplied parameter pointer and
 * will delete it upon destruction.
 */
DCTypedef::
...
/**
 * Returns a unique index number associated with this typedef definition.  This
 * is defined implicitly when the .dc file(s) are read.
 */
int DCTypedef::
get_number() const {
  return _number;
...
/**
 * Returns true if the typedef has been flagged as a bogus typedef.  This is set
 * for typedefs that are generated by the parser as placeholder for missing
 * typedefs, as when reading a partial file; it should not occur in a normal
 * valid dc file.
 */
bool DCTypedef::
...
/**
 * Returns true if the typedef has been flagged as an implicit typedef, meaning
 * it was created for a DCClass that was referenced inline as a type.
 */
bool DCTypedef::
...
/**
 * Returns a newly-allocated DCParameter object that uses the same type as that
 * named by the typedef.
 */
