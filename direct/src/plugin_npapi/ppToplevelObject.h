...
/**
 * This is a special object fed to Mozilla as the toplevel scripting object
 * for the instance.  It has only one property, "main", which corresponds to
 * the appRunner.main object from Python.
 */
