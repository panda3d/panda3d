...
remove_c_interval(int index) {
  ...
  nassertv(def._interval != (CInterval *)nullptr);
  ...
  def._interval = (CInterval *)nullptr;
...
interrupt() {
  ...
  while (ni != _name_index.end()) {
    ...
    nassertr(def._interval != (CInterval *)nullptr, num_paused);
...
get_next_event() {
  ...
  while (_next_event_index < (int)_intervals.size()) {
    ...
    if (def._interval != (CInterval *)nullptr) {
...
get_global_ptr() {
  if (_global_ptr == (CIntervalManager *)nullptr) {
