...
/**
 * This function updates the main steering force for the ai character using the
 * accumulate function and checks for max force and arrival force.  It finally
 * returns this steering force which is accessed by the update function in the
 * AICharacter class.
 */
...
/**
 * This function activates seek and makes an object of the Seek class.  This is
 * the function we want the user to call for seek to be done.  This function is
 * overloaded to accept a NodePath or an LVecBase3.
 */
...
/**
 * This function activates flock.  This is the function we want the user to call
...
/**
 * This function contains the logic for flocking behavior.  This is an emergent
 * behavior and is obtained by combining three other behaviors which are
 * separation, cohesion and alignment based on Craig Reynold's algorithm.  Also,
 * this behavior does not work by itself.  It works only when combined with
 * other steering behaviors such as wander, pursue, evade, seek and flee.
 */
 ...
 * the function we want the user to call for obstacle avoidance to be performed.
 */
...
/**
 * This function activates path finding in the character.  This function accepts
 * the meshdata in .csv format.
 */
