...
/**
 * This class implements a linked list of AI Characters allowing the user to add
 * and delete characters from the linked list.  This will be used in the AIWorld
 * class.
 */
